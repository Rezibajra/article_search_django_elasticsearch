...
class ArticleSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return Article(validated_data['title'], validated_data['body'], validated_data['tags'], validated_data['published_from'], validated_data['lines'], validated_data['is_published'])
